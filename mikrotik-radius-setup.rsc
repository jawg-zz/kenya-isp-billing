...
# After import, configure redirect manually (if needed):
# /ip hotspot profile set hotspot-radius http-redirect=yes redirect-url=https://isp.spidmax.win/hotspot/login.html
