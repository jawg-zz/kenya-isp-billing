...
/interface pppoe-server server add service-name=isp-pppoe interface=bridgelan default-profile=pppoeradius authentication=pap,chap one-session-per-host=yes address-pool=pppoepool
