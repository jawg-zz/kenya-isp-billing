...
# RouterOS 7.x - Fully Reset Router
...
/ip dhcp-server add name=dhcp-lan interface=bridge-lan address-pool=dhcp-pool gateway=192.168.89.1 dns-server=192.168.89.1
...
/ppp profile add name=pppoe-radius local-address=192.168.89.1 remote-address-pool=pppoe-pool bridge=bridge-lan use-mpls=no use-compression=no use-encryption=no override-mtu=1492
