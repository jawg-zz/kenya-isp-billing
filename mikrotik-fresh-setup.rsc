...
/ppp profile add name=pppoeradius local-address=192.168.89.1 remote-address-pool=pppoepool bridge=bridgelan
/interface pppoe-server server add service-name=isp-pppoe interface=bridgelan default-profile=pppoeradius authentication=pap,chap one-session-per-host=yes
